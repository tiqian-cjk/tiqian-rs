...
// tiqian/tools/unicode-emoji/generate_emoji_presentation_data.py.
...
fn fully_qualified_emoji_sequences_resolve_to_one_emoji_range() {
    assert_eq!(3944, FULLY_QUALIFIED_CODE_POINT_SEQUENCES.len());
    ...
    let failures: Vec<_> = FULLY_QUALIFIED_CODE_POINT_SEQUENCES
        ...
        .filter_map(|code_points| {
            ...
            .collect::<Vec<_>>();
            let expected = vec![(text_range(0, text.chars().count() as i32), FontRole::Emoji)];
            (actual != expected)
...
const FULLY_QUALIFIED_CODE_POINT_SEQUENCES: &[&str] = &[
    "1F600",
    "1F603",
    "1F604",
    "1F601",
