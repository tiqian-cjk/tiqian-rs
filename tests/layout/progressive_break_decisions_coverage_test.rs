...
use tiqian::layout::progressive_break_decisions::{
    ProgressiveBreakOpportunity, ProgressiveBreakTier, decide_hyphen_break,
    decide_progressive_break, progressive_candidate_allowed,
};
...
fn candidates_of_a_different_span_are_allowed() {
    let opportunities = HashMap::from([
        ...
        (
            3,
            ProgressiveBreakOpportunity::new(ProgressiveBreakTier::Whitespace, text_range(2, 6)),
        ),
    ]);
