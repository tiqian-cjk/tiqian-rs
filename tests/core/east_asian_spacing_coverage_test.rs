...
fn test_unicode_script_evidence() {
    ...
    assert_eq!(UnicodeScriptEvidence::EastAsian, unicode_script_evidence_classifier::classify('中'));
    assert_eq!(UnicodeScriptEvidence::Other, unicode_script_evidence_classifier::classify('A'));
    assert_eq!(UnicodeScriptEvidence::Neutral, unicode_script_evidence_classifier::classify(' '));
}

#[test]
fn test_east_asian_spacing_data_and_values() {
    assert_eq!(EastAsianSpacingValue::Wide, unicode_east_asian_spacing::property_of('\u{02C7}'));
    assert_eq!(EastAsianSpacingValue::Narrow, unicode_east_asian_spacing::property_of('0'));
    assert_eq!(EastAsianSpacingValue::Conditional, unicode_east_asian_spacing::property_of('!'));
    assert_eq!(EastAsianSpacingValue::Other, unicode_east_asian_spacing::property_of('\0'));
    assert_eq!(EastAsianSpacingValue::Other, unicode_east_asian_spacing::property_of('\u{10FFFF}'));
}