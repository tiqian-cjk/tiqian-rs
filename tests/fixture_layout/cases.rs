...
pub fn fixtures() -> Vec<Fixture> {
    vec![
        ...
        fixture(
            ...
            "中文“对A”“波霸”；中文“欧派”“double”“double may”呢",
            320.0,
        ),
        fixture(
            "mi10s-adjacent-curly-quote-wrap",
            "所以这个和 “骑ji” “说shui”“斜xiá”不一样，港台是从众的，大陆读音大多数源自韵书。",
            160.0,
        ),
        without_grid(
            "mi10s-western-bracket-citation-wrap",
            "史力军,姚晨,杨国玉,等.常见有机化合物中文词汇的读音详解[J].化学教育(中英文), 2023, 44(10):21-38.",
            272.0,
        ),
        without_grid(
        ...
        fixture(
            ...
            "’90s James’； “truncated；中文“未闭",
            240.0,
        ),
        fixture("fallback-roles", "提椠……Hello——世界。", 240.0),
        fixture(
            "greedy-multi-line",
            "咖啡馆比咖啡更早地改变了城里人的作息与谈吐。",
            144.0,
        ),
        ...
        fixture(
            "latin-word-wrap",
            "他引用了一句话：The quick brown fox jumps over the lazy dog，然后继续讲。",
            240.0,
        ),
        emphasis_marks(),
        ruby_line_height(),
        ...
        fixture(
            ...
            "链接 https://example.com/path/to/abc123def456ghi789",
            160.0,
        ),
        fixture(
            "zero-width-space-soft-break",
            "A.\u{200B}.\u{200B}.Complete？AaFont？",
            96.0,
        ),
        hyphenated(
            "western-hyphenation",
        ...
        fixture(
            ...
            "中文—下句；等…真。 English — next; ellipsis… / slash. A——B; Wait……what? 中文—English\n——中文\n……",
            1024.0,
        ),
        fixture(
            "parenthetical-dash-pairs",
            "他彻夜想Jessica——Jessica是他的前女友——睡不着觉。地点——北京，时间——明天。",
            1024.0,
        ),
        fixture(
            "quote-digit-boundaries",
            "中文 le“t”ters 中1“1”2文；中Ａ“Ｂ”Ｃ文。尾号是“1‘2’3”，用时1’30”。",
            1024.0,
        ),
    ]
}
...
fn progressive_technical_inline() -> Fixture {
    let mut fixture = hyphenated(
        "progressive-technical-inline",
        "中文 internationalization 命令",
        160.0,
    );
...
fn progressive_technical_hash_fill() -> Fixture {
    let mut fixture = without_grid(
        "progressive-technical-hash-fill",
        "deadbeefcafebabefeedfaceabcdefabcdef",
        173.0,
    );
    fixture.use_english_hyphenation = true;
    fixture.input.content.line_break_spans = vec![LineBreakSpan {
