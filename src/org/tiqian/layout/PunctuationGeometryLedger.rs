...
use super::super::clreq::ClreqProfile::PunctuationClass;
...
impl PunctuationGeometryLedger {
    ...
    pub fn consume_line_edge_glue(
        &self,
        lines: &[super::LineBreaker::LineCandidate],
    ...
    fn schedule_edge(
        &self,
        line: &super::LineBreaker::LineCandidate,
        index: i32,
