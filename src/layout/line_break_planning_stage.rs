...
use super::punctuation_geometry_stage::{
...
use super::punctuation_model::{PunctuationAtom, PunctuationSpacingCompressionResult};
use super::quote_pair_analyzer::QuotePair;
use super::unicode_punctuation_boundary_resolver::{
...
use super::width_independent_annotation_cache::containing_items;
...
pub struct ParagraphLayoutPrep {
    ...
    pub inline_object_boundary_unbreakable_ranges: Vec<super::super::core::int_range::IntRange>,
    ...
    pub inline_object_punctuation_attachment_decisions:
        Vec<super::super::core::layout_model::InlineObjectPunctuationAttachmentDecisionInfo>,
...
pub struct LineBreakPlanningStageResult {
    ...
    pub line_spacing_decision: Option<super::super::core::layout_model::LineSpacingDecisionInfo>,
    pub block_indent: f32,
    pub first_line_indent: f32,
    pub first_line_indent_decision: super::super::core::layout_model::FirstLineIndentDecisionInfo,
    pub kinsoku_decision: super::super::core::layout_model::KinsokuDecisionInfo,
    ...
    pub line_solution: super::line_optimization::LineSolution,
}
...
pub fn plan_paragraph_lines(request: LineBreakPlanningRequest<'_>) -> LineBreakPlanningStageResult {
    ...
    let base_metrics: Vec<_> = metric_decisions
        ...
        .filter(|decision| {
            decision.layout_metrics.metric_box
                == super::super::font::font_metrics::MetricBox::IdeographicEmBox
        })
        .collect();
    ...
    let line_spacing_decision = (base_line_metrics.height > 0.0).then(|| {
        ...
        super::super::core::layout_model::LineSpacingDecisionInfo {
    ...
    let first_line_indent_decision =
        super::super::core::layout_model::FirstLineIndentDecisionInfo {
    ...
    let kinsoku_decision = super::super::core::layout_model::KinsokuDecisionInfo {
        measure_em: prep.measure_em,
    ...
    let hangable_clusters: HashSet<_> = match prep.resolved_kinsoku.hanging {
        super::super::clreq::clreq_profile::HangingPunctuationStyle::Disabled => HashSet::new(),
        super::super::clreq::clreq_profile::HangingPunctuationStyle::PauseStops => prep
            .natural_clusters
            .iter()
            .enumerate()
    ...
    let line_solution = if prep.text.is_empty() {
        super::line_optimization::LineSolution::new(Vec::new())
    } else {
        ...
        config.line_adjustment_push_in = prep.adjustment_style.line_adjustment
            != super::super::clreq::clreq_profile::LineAdjustmentStrategy::PushOutOnly;
        config.line_adjustment_compress_bias = match prep.adjustment_style.line_adjustment {
            super::super::clreq::clreq_profile::LineAdjustmentStrategy::PushInFirst => 1_000_000.0,
            super::super::clreq::clreq_profile::LineAdjustmentStrategy::PushOutFirst => 0.5,
            super::super::clreq::clreq_profile::LineAdjustmentStrategy::PushOutOnly => 0.0,
        };
